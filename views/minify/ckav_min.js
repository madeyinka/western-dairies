...
(function ($) {
    ...
    ckav.backgroundImage = function (element) {
        element.css({ backgroundImage: "url('" + element.attr("data-bg-image") + "')" });
    };
    ...
    ckav.slideshow = function (element) {
        if ($().vegas) {
            ...
            element.vegas({ delay: 4000, slides: bgslides, timer: !1, animation: "kenburns" });
        }
    };
    ckav.backgroundYoutube = function (element) {
        ...
        if (isMobile.any()) {
            ...
            if (element.attr("data-videoid")) {
                element.YTPlayer({ videoId: element.attr("data-videoid"), start: element.attr("data-start") ? parseInt(element.attr("data-start")) : 0, onReady: function (player) {} });
            }
        }
    };
    ...
    ckav.linearGredient = function (element) {
        ...
        element.css({ background: "linear-gradient(to bottom, " + grdColor[0] + " 0%, " + grdColor[1] + " 100%)" });
    };
    ckav.radialGredient = function (element) {
        var rgrdColors = $(element).attr("data-radial-gradient"),
            rgrdColor = rgrdColors.split("|");
        element.css({ background: "radial-gradient(circle, " + rgrdColor[0] + " 0%, " + rgrdColor[1] + " 100%)" });
    };
    ...
    ckav.carousel = function (element) {
        if ($().owlCarousel) {
            ...
            var resObj = { 0: { items: 1 }, 420: { items: 2 }, 600: { items: 3 }, 768: { items: 3 }, 980: { items: 4 } };
    ...
    ckav.contactForm = function ($form, formData, validate_data) {
        ...
        if ($form.valid()) {
            ...
            $.ajax({
                url: 'http://localhost:10230/sendmail',
                type: "POST",
                data: f_data,
            ...
            if ($o.$navigationLink) {
                ...
                if ($o.$html.hasClass("device-mobile")) {
                    $o.$navigationLink.on("click", function () {
                        ...
                        $("html, body").animate({ scrollTop: $toSection.offset().top - 40 }, 600);
                        $o.$ckavBody.removeClass("theme-light theme-dark");
    ...
    ckav.getObj = function () {
        var obj = {
            ...
            $navigationLink: $(".navlink").length > 0 ? $(".navlink") : !1,
            $carouselWidget: $(".carousel-widget").length > 0 ? $(".carousel-widget") : !1,
            $navlinkLauncher: $(".navlink-launcher").length > 0 ? $(".navlink-launcher") : !1,
            $scrollTo: $(".scroll-to-section").length > 0 ? $(".scroll-to-section") : !1,
            $sectionTo: $(".section-to").length > 0 ? $(".section-to") : !1,
            ...
            $pageSectionWrp: $(".page-section-wrp").length > 0 ? $(".page-section-wrp") : !1,
            $pageSection: $(".page-section").length > 0 ? $(".page-section") : !1,
