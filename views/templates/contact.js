exports.emailTemplate = async (name, email, subject, message) => {
    const html = 
        ...
        <head>
            ...
            <title>Western Dairies Contact Message</title>
            <style type="text/css">
                img {
                    max-width: 100%;
                }
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                                    <h4>Sender Name:</h4>${name}<br>
                                                    <h4>Sender Email:</h4>${email}<br>
                                                    <h4>Subject:</h4>${subject}<br>
                                                    <h4>Message:</h4>${message}<br>
                                                </td>
                                            </tr>
                                            <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                                <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top text-align="center"">
                                                Western Dairies | facebook | twitter | instagram
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
